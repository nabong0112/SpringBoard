					...
					<c:choose>
						<c:when test="${bestboard.size() != 0}">
							...
							<c:forEach items='${bestboard}' var='list'>
								...
								<tr align="center">
									<td width="80"><a href="read?boardNo=${list.boardNo}&boardType=3"><c:out
												value='${i}' /></a></td>
									<td width="640"><a href="read?boardNo=${list.boardNo}&boardType=3"><c:out
		...
		<table style="line-height: 2.3em;" draggable="true">
			...
			<c:choose>
				 <c:when test="${listboard.size() != 0}">
						...
						<tr align="center">
							<td width="80"><a href="read?boardNo=${list.boardNo}&boardType=3">
								<c:out value='${j}'/></a></td>
							<td width="640"><a href="read?boardNo=${list.boardNo}&boardType=3">
