...
<body>
	<div id="container">
		...
		<div id="content"
			...
			<div id="boardName">
				<p style="display: inline;">질문 게시판</p>
					...
					<c:choose>
						<c:when test="${bestboard.size() != 0}">
							...
							<c:forEach items='${bestboard}' var='list'>
								...
								<tr align="center">
									<td width="80"><a href="read?boardNo=${list.boardNo}&boardType=2"><c:out
												value='${i}' /></a></td>
									<td width="640"><a href="read?boardNo=${list.boardNo}&boardType=2"><c:out
		...
		<table style="line-height: 2.3em;" draggable="true">
			...
			<c:choose>
				 <c:when test="${listboard.size() != 0}">
						...
						<tr align="center">
							<td width="80"><a href="read?boardNo=${list.boardNo}&boardType=2">
								<c:out value='${j}'/></a></td>
							<td width="640"><a href="read?boardNo=${list.boardNo}&boardType=2">
